...
(custom-set-variables
 ...
 '(linum-eager nil)
    ...
    '(org-agenda-files
         (quote
             ("~/.emacs.d/settings.org" "~/Dropbox/org_files/da_guai.org")))
 '(org-modules (quote (org-docview org-habit org-info org-mhe org-w3m)))
    '(package-selected-packages
         (quote
             (json-mode xref-js2 indium page-break-lines dashboard rjsx-mode material-theme realgud go-mode pyenv-mode key-chord smartscan helm-ag helm-projectile dockerfile-mode paredit cider aurora aurora-theme gitignore-mode skewer-mode skewer apropospriate-theme company-anaconda anaconda-mode define-word nginx-mode peep-dired dired-narrow web-mode markdown-mode fullframe sane-term mouse+ undo-tree auto-complete company flycheck multiple-cursors wrap-region syntax-subword expand-region git-timemachine git-gutter-fringe+ git-gutter+ magit yasnippet js2-mode yaml-mode projectile deft transpose-frame hydra org-bullets fixmee rainbow-delimiters avk-emacs-themes use-package)))
