...
** TEMP
#+BEGIN_SRC emacs-lisp
(defvar my-electic-pair-modes '(python-mode org-mode lisp-interaction-mode emacs-lisp-mode tenjin-mode))
...
(defun my-ediff-no-ask (old-function &rest arguments)
  "docsting"
  (ediff-current-file)
  (old-functon arguments)
)

;;(advice-add #'ask-user-about-lock :around #'my-ediff-no-ask)
