...
** Saved macros
#+BEGIN_SRC emacs-lisp
(fset 'log-highlighted
   (lambda (&optional arg) "Keyboard macro." (interactive "p") (kmacro-exec-ring-item (quote ([134217847 5 return 108 108 111 103 tab 39 25 5 return 108 108 111 103 tab 25] 0 "%d")) arg)))
#+END_SRC
...
(use-package projectile
  ...
  (progn
    ...
    (add-to-list 'projectile-globally-ignored-directories "ui/client_portal/views/javascript/builds")
    (add-to-list 'projectile-globally-ignored-directories "ui/client_portal/views/javascript/vendor")
    (add-to-list 'projectile-globally-ignored-directories "ui/client_portal/Chrome_.*")
    (add-to-list 'projectile-globally-ignored-directories "ui/client_portal/Chrome_71.0.3578_(Mac_OS_X_10.13.6)")
    (add-to-list 'projectile-globally-ignored-directories "ui/bower_components")
...
(use-package key-chord
  ...
  (progn
    ...
    (key-chord-define-global "LL" 'log-highlighted)
    )
  )
#+END_SRC
...
;; (defun build-dev ()
;;   (shell-command "build_dev"))

;; (add-hook 'js2-mode-hook
;;           (lambda () (add-hook 'before-save-hook #'build-dev nil 'local)))
...
(setq magic-mode-alist (delete '("^[{[]$" . json-mode) magic-mode-alist))
 )
#+END_SRC
