...
(defvar es/electic-pair-modes
  '(python-mode org-mode lisp-interaction-mode emacs-lisp-mode tenjin-mode, yaml-mode))
...
(defun es/sync-corgi-tasks ()
  ...
  (let ((taskfile (get-buffer "da_guai.org")))
    (if taskfile
    (save-some-buffers)
...
(global-set-key "\C-ca" 'es/org-agenda)
...
** REVIEW Navigation
** REVIEW Custom functions for navigation
#+BEGIN_SRC emacs-lisp
...
(use-package elpy
  :init
  (load "elpy")
  (setq elpy-modules (remq 'elpy-module-yasnippet elpy-modules))
  (elpy-enable)
...
** REVIEW smart-mode-line
#+BEGIN_SRC emacs-lisp
(use-package smart-mode-line
  :disabled t
  :init
  (setq sml/theme 'respectful)
  (sml/setup)  ; Currently this function messes up pep8 warnings for some reason
)
#+END_SRC

** REVIEW Assorted custom functions
#+BEGIN_SRC emacs-lisp
