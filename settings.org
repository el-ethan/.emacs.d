...
;; Make sure emacs is not suspended when I accidently hit C-z
...
;(use-package aurora)
;;Get an ok-looking theme in command line
...
#+BEGIN_SRC emacs-lisp 
  ...
  (global-set-key (kbd "C-c s") 
    (lambda () (interactive) (find-file "~/Dropbox/configs/settings.org")))
...
;; (setenv "PYTHONPATH" "$PYTHONPATH:/home/ethan/Dropbox/development/kivy_fork/kivy")
...
#+BEGIN_SRC emacs-lisp
  (use-package git-gutter
    ...
    ;; This messes things up if you are not using linum-mode
    ;;(git-gutter:linum-setup)
...
;; Use YAML mode since kivy-mode doesn't seem to work...
...
#+BEGIN_SRC emacs-lisp 
(global-set-key (kbd "<f10>") (kbd "M-& terminator"))
