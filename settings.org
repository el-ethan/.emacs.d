...
(setq org-agenda-custom-commands
     ...
     ((tags-todo
       "-DEADLINE={.+}-SCHEDULED={.+}-notes-someday-emacs-work-projects-beilei")
      (agenda "")
      )
...
** TEMP
#+BEGIN_SRC emacs-lisp
(define-key org-agenda-mode-map [remap org-agenda-next-line] 'org-agenda-next-item)
(define-key org-agenda-mode-map [remap org-agenda-previous-line] 'org-agenda-previous-item)j
