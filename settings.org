...
(setq org-agenda-custom-commands
     ...
     ((tags-todo
       "-DEADLINE={.+}-SCHEDULED={.+}-dad-mom-beilei-notes-someday-emacs-work")
      ;; (agenda "") ;;Uncomment if you start using this as an agenda with deadlines again
      )
...
(add-hook 'pdb-mode-hook 'compilation-shell-minor-mode)
#+END_SRC
